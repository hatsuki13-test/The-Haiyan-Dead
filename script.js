...
function startTypewriter(el) {
  ...
  function step() {
    ...
    if (wordIndex < words.length) {
      ...
      wordIndex++;
      setTimeout(step, 200); // typing speed per word
    } else {
      // end of line: paragraph break
      el.innerHTML += "<br><br>";
      lineIndex++;
...
/* ========= OUTRO CREDITS (cinematic roll) ========= */
function startCreditsRoll() {
  const roll = document.getElementById("credits-roll");
  const creditsText = (
    "Thank you for visiting my website.\n\n" +
    "Especially to you, Ma'am Fortuno.\n\n" +
    "Creator: Jhon Mark Lumibao\n" +
    "Video Editor: Jhon Mark Lumibao\n" +
    "Editing: Justin Ibabao\n" +
    "Storyline: Jhon Mark Lumibao & Justin Ibabao\n" +
    "Upload: Justin Ibabao\n\n" +
    "— The End —"
  );
  roll.style.animation = "none";
  roll.offsetHeight; // reflow to restart
  roll.textContent = creditsText;
  roll.style.animation = ""; // uses CSS keyframes 'creditsUp'
}

/* ========= WEATHER CANVAS (rain + clouds + lightning) ========= */
